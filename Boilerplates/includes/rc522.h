...
#define MFRC522_CS_PORT				SS_RFID_GPIO_Port
#define MFRC522_CS_PIN				SS_RFID_Pin
#define MFRC522_RST_PORT			RST_RFID_GPIO_Port
#define MFRC522_RST_PIN				RST_RFID_Pin
